...
import { Home, Sparkles, Utensils, HeartHandshake } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-3xl bg-homatri-orange-light p-8 border border-homatri-orange/20 shadow-lg">
              <div className="space-y-6">
                
                {/* Story Quote Card */}
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-homatri-border">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-extrabold text-homatri-dark">
                        "Craving authentic Gongura Pappu from Telangana..."
                      </p>
                    </div>
                  </div>
                  <p className="text-xs text-homatri-muted italic">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 bg-homatri-orange-light text-homatri-orange px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
              <Home className="w-3.5 h-3.5" />
              <span>A Home Away From Home</span>
            </div>

            <h2 className="text-3xl sm:text-4xl font-black text-homatri-dark tracking-tight leading-tight">
              Authentic Regional Home Food, <br />
              <span className="text-homatri-orange">Cooked Just Like Mom Made.</span>
            </h2>

            <p className="text-homatri-muted text-base leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="flex items-start gap-3">
                <div className="p-2 bg-homatri-orange-light rounded-lg text-homatri-orange shrink-0">
                  <Utensils className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-sm font-bold text-homatri-dark">Authentic Hometown Taste</h4>
                  <p className="text-xs text-homatri-muted">Native recipes crafted by homemakers from your home state.</p>
                </div>
              </div>

              <div className="flex items-start gap-3">
                <div className="p-2 bg-homatri-green-light rounded-lg text-homatri-green shrink-0">
                  <HeartHandshake className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-sm font-bold text-homatri-dark">Healthy Daily Meals</h4>
                  <p className="text-xs text-homatri-muted">Clean ingredients, minimal oil, perfect for daily lunch & dinner.</p>
                </div>
              </div>
            </div>
