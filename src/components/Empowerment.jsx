    ...
    <section className="py-20 bg-homatri-cream border-b border-homatri-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 bg-white text-homatri-orange border border-homatri-orange/20 px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider mb-4 shadow-sm">
            <Award className="w-3.5 h-3.5" />
            <span>The Homemaker Movement</span>
          </div>
          
          <h2 className="text-3xl sm:text-4xl font-black text-homatri-dark tracking-tight">
            Empowering Homemakers. <br />
            <span className="text-homatri-orange">Your Kitchen, Your Business.</span>
          </h2>

          <p className="mt-4 text-base text-homatri-muted leading-relaxed font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-3xl border border-homatri-border shadow-sm hover:shadow-md transition-shadow">
