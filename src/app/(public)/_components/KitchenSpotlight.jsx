...
const FEATURED_KITCHENS = [
  {
    id: "gharachi_chav",
    name: "घरची चव (Gharachi Chav)",
    chef: "Shrushti Vivek Sutar",
    ...
    lunchPrice: 210,
    dinnerPrice: 170,
    cuisine: "Aagri & Coastal Indian",
  },
  {
    id: "aagri_tadka",
    name: "AAGRI TADKA",
    chef: "Hemlata Shravan Sutar (30 Yrs Exp)",
    locality: "Sector 5, Ghansoli",
    rating: 4.9,
    reviews: 188,
    diet: "AAGRI SPECIALIST",
    dietColor: "bg-amber-50 text-amber-700 border-amber-200",
    signatureDish: "Pineapple Sheera & Aagri Thali",
    lunchPrice: 210,
    dinnerPrice: 140,
    cuisine: "Authentic Aagri Food",
  },
  {
    id: "malvan_kitchen",
    name: "Malvan Kitchen",
    chef: "Prachika Lohar (20 Yrs Exp)",
    locality: "Sector 4, Ghansoli",
    rating: 4.8,
    reviews: 164,
    diet: "MALVANI COASTAL",
    dietColor: "bg-blue-50 text-blue-700 border-blue-200",
    signatureDish: "Malvani Fish Curry & Puran Poli",
    lunchPrice: 210,
    dinnerPrice: 140,
    cuisine: "Authentic Malvani",
  },
  {
    id: "dilses_kitchen",
    name: "Dilse's Kitchen",
    chef: "Sumitra Dolas",
    locality: "Sector 8, Ghansoli",
    rating: 4.9,
    reviews: 135,
    diet: "MAHARASHTRIAN",
    dietColor: "bg-emerald-50 text-emerald-700 border-emerald-200",
    signatureDish: "Thecha Chicken Thali & Modak",
    lunchPrice: 170,
    dinnerPrice: 140,
    cuisine: "Maharashtrian Special",
  },
];
